        ...
        <div class="container">
          ...
          <div style={{backgroundColor:'white'}}>
            ...
            <div style={{marginLeft:'25%',marginRight:'25%',textAlign:'left'}}>
              ...
              <p>Germany</p>
              <br/>
              <p>e-mail: info@blackgoose.games</p>
              <br/>
              <p>Executive Board: Christian Wilp</p>
              <p>HRB 13536 NP</p>
          ...
          <div style={{backgroundColor:'white'}}>
            ...
            <h2 style={{fontWeight: "bold"}}>Privacy statement Black Goose Games UG</h2>
              ...
              <p>Controller: Black Goose Games UG,</p>
              <p>Poststraße 8,</p>
              <p>16798 Fürstenberg,</p>
              <p>represented by the CEO Christian Wilp,</p>
              <p>e-mail:  info@blackgoose.games</p>

              <p style={{fontWeight: "bold"}}>2. Collection and storage of personal data and the purpose of their use</p>
              <p style={{fontWeight: "bold"}}>a) When visiting our websites</p>
              <p>When accessing our website blackgoose.games,the browser used on your end device automatically sends information to our website’s server. This information is stored temporarily in a so-called log file. The following information is collected and stored without any action on your part, until its automatic erasure:</p>
              <p>• IP address of the accessing computer</p>
              <p>• Date and time of the access</p>
              <p>• Name and URL of the retrieved file</p>
              <p>• Website from which access was made</p>
              <p>• Browser used and, where applicable, the operating system of your computer and the name of your access provider.</p>

              <p>The aforementioned data will be processed by us for the following purposes:</p>
              <p>• Guaranteeing the smooth connection setup of the website</p>
              <p>• Guaranteeing the comfortable use of our website</p>
              <p>• Evaluating system security and stability, and</p>
              <p>• Other administrative purposes</p>
              <p>The legal basis for the data processing is Art. 6 (1) lit. f GDPR. Our legitimate interest is derived from the purposes listed above for data collection. Under no circumstances shall we use the data collected for the purpose of making any inferences to your person.</p>

              ​<p style={{fontWeight: "bold"}}>b) When contacting us per E-Mail or using our contact form</p>
              <p>For questions of any kind, we offer you the opportunity to contact us via a form provided on our website or our e-mail address. In this case, your e-mail address is a mandatory data and is required in order to be able to assign and answer the request. Further information can be given voluntarily. The processing of data for the purpose of contacting us takes place in accordance with Art. 6 para. 1 sent. 1 lit. a DSGVO based on your voluntarily granted consent. The personal data collected by us for the use of the contact form will be deleted after completion of the request made by you.</p>

              <p style={{fontWeight: "bold"}}>c) When registering for our newsletter</p>
              <p>If you have granted your express permission pursuant to Art. 6 clause 1 first sentence letter a GDPR, we will use your e-mail address to send you our newsletter on a regular basis. In order to receive the newsletter, it is sufficient to only provide an e-mail address.</p>
              ...
              <p>You can unsubscribe at any time, for example using a link. Alternatively, you can also e-mail your unsubscription request to info@blackgoose.games” at any time.</p>
              <p>Once we have received your cancellation of the newsletter subscription, we will immediately delete your email address from our distribution list.</p>

              ​<p style={{fontWeight: "bold"}}>3. Forwarding data​</p>
              ​<p>Your personal data will not be transferred to any third party for any purpose other than those listed below.
              We shall forward your personal data to third parties only<br/><br/>
              • if you have given your explicit consent, in accordance with Art. 6 (1) a GDPR <br/><br/>
              ​• if under Art. 6 (1) f GDPR the transfer is necessary for the establishment, exercise or defence of legal claims, and there is no reason to assume that you have an overriding interest, which must be protected, in the non-forwarding of your data<br/><br/>
              ​• in the event that there is a legal obligation to forward the data under Art. 6 (1) c GDPR and if this is legally permissible and necessary under Art. 6 (1) b GDPR for the processing of contractual relationships with you.<br/>
              </p>

              <p style={{fontWeight: "bold"}}>4. Cookies</p>
              <p>
              ...
              The use of cookies serves on the one hand to make the use of our offer more comfortable for you. Thus we use so-called session cookies in order to recognise that you have already visited individual pages of our website. These are deleted automatically once you leave our website.
              ...
              <p style={{fontWeight: "bold"}}>5. Analytical tools</p>
              <p>
              ...
              <p style={{fontWeight: "bold"}}>I. blackgoose.games</p>
              <p>New Relic</p>
              <p>
              ...
              <p>The respective plug-in provider stores the data transmitted to it, irrespective of whether you are also logged-in to your user account at the respective plug-in provider as a rule as user profiles, which are used for the following purposes:</p>
              <p>- Advertising suitable for the needs</p>
              <p>- Market research</p>
              <p>- Optimization of the websites of the plug-in provider suitable for the needs.</p>
              <p>
              ...
              <p>• pursuant to Art. 15 GDPR, to demand information about your personal data that we have processed. In particular, you can obtain information about the purposes of the processing, The categories of personal data concerned, the recipients or category of recipients to whom you data have been or will be disclosed, the envisaged period for which the data will be stored, the existence of the right to request rectification, erasure, or restriction of the processing, or to object to it, the right to lodge a complaint with a supervisory authority, the source of your data, if these have not been collected by us, and on the existence of automated decision-making, including profiling, and any other meaningful information about their details or the logic involved;</p>
              <p>• pursuant to Art. 16 GDPR, to demand the immediate rectification or completion of inaccurate personal data stored by us;</p>
              <p>• pursuant to Art. 17 GDPR, to demand the erasure of personal data stored by us, unless their processing is necessary for exercising the right of freedom of expression and information, for compliance with a legal obligation, for reasons of public interest, or for the establishment, exercise or defence of legal claims;</p>
              <p>• pursuant to Art. 18 GDPR, to demand the restriction of the processing of your personal data in cases where you contest the accuracy of the data, where the processing is unlawful yet you oppose the erasure of the personal data, where we no longer need the data but you still require them to establish, exercise or defend legal claims, or where you have objected to the processing of the data pursuant to Art. 21 GDPR;</p>
              <p>• pursuant to Art. 20 GDPR, to obtain your personal data that you have provided to us in a structured, commonly used and machine-readable format and to demand the transfer of these data to another controller;</p>
              <p>• pursuant to Art. 7 (3) GDPR, to withdraw your consent at any time, which will mean that in future we may no longer carry out the data processing that was contingent upon this consent and</p>
              <p>• pursuant to Art. 77 GDPR, to lodge a complaint with a supervisory authority. In general you can contact the supervisory authority of your usual residence or place of employment, or that of our company headquarters for this purpose.</p>

              <p style={{fontWeight: "bold"}}>8. Right of objection</p>
              <p>
              ...
              If you wish to avail of your right to withdraw or object, an e-mail to info@blackgoose.games will suffice.
              </p>

              <p style={{fontWeight: "bold"}}>9. Data security</p>
              <p>
